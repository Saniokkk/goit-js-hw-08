...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const n=document.querySelector("iframe"),o=new Vimeo.Player(n);let r=null;const c=(0,e.default)(function({seconds:e}){r=e,localStorage.setItem("videoplayer-current-time",r)},1e3);o.on("timeupdate",c);const u=localStorage.getItem("videoplayer-current-time");u&&o.setCurrentTime(u).then(function(e){}).catch(function(e){e.name});
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.5aefd242.js.map