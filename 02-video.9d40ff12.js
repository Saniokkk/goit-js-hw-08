...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector("iframe"),n=new Vimeo.Player(o);let r=null;const l=(0,e.default)(function({seconds:e}){r=e,localStorage.setItem("videoplayer-current-time",r)},1e3);n.on("timeupdate",l),console.log(localStorage.getItem("videoplayer-current-time")),n.getCurrentTime().then(function(e){}).catch(function(e){});
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.9d40ff12.js.map