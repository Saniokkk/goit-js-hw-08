...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),r={};function o(e){r[e.target.name]=e.target.value,localStorage.setItem("feedback-form-state",JSON.stringify(r))}function s(e){e.preventDefault(),e.currentTarget.reset(),console.log(r),localStorage.removeItem("feedback-form-state")}function n(){const e=JSON.parse(localStorage.getItem("feedback-form-state"));e&&(e.message&&(a.message.value=e.message),e.email&&(a.email.value=e.email))}n(),a.addEventListener("input",(0,e.default)(o,500)),a.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.d1aca64d.js.map