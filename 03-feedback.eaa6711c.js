...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");let r={};function l(e){r[e.target.name]=e.target.value,localStorage.setItem("feedback-form-state",JSON.stringify(r))}function o(e){e.preventDefault(),""===e.target.email.value||""===e.target.message.value?alert("Все поля должны быть заполнены!!!"):(e.currentTarget.reset(),console.log(r),localStorage.removeItem("feedback-form-state"),r={})}function s(){const e=JSON.parse(localStorage.getItem("feedback-form-state"));e&&(e.message&&(a.message.value=e.message),e.email&&(a.email.value=e.email))}s(),a.addEventListener("input",(0,e.default)(l,500)),a.addEventListener("submit",o);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.eaa6711c.js.map